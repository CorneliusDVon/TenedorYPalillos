...
namespace TenedorYPalillos.Model.DTO.Log
{
    ...
    public class LogResquestDTO
    {
        ...
        public LogResquestDTO(string society, string method, string libraryClass, DateTime date, string message, string detail, string comment)
        {
    ...
    public class LogResponseDTO
    {
        ...
        public LogResponseDTO(string society, long id, string method, string libraryClass, DateTime date, string message, string detail, string comment)
        {
            Society = society;
            Id = id;
            Method = method;
